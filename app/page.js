  ...
  return (
    <main className="">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-10 xl:gap-[150px] items-center ps-4">
        <Image src={"/shared-piz.png"} width={400} height={400} className="w-[300px] h-[300px]  xl:h-[400px] xl:w-[400px]"/>
        <div>
        ...
        <Image src={"/galic.png"} width={90} height={90} className=" h-[60px] lg:h-[90px"/>
