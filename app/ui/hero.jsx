         ...
         <div className="ps-4">
            ...
            <OrderButton/>
              ...
              <div className="flex justify-end">
                ...
                <Image src={"/tomato-piz.png"} width={400} height={400} className="h-[200px] lg:h-[250px] xl:h-[400px] w-[200px] lg:w-[250px] xl:w-[400px]"/>
                <Image src={"/onion.png"} width={100} height={100} className="h-[60px] xl:h-[120px] w-[60px] xl:w-[120px] ms-[-50px] mt-[120px] lg:mt-[80px] xl:ms-[-120px] xl:mt-[-50px]"/>
                <Image src={"/nut-piza.png"} width={170} height={170} className="h-[120px] xl:h-[170px] w-[120px] xl:w-[170px] absolute right-[0px] lg:right-[-20px] bottom-[-50px] xl:bottom-[-130px]"/>
            </div>
