        ...
        <Image src={'/leaf.png'} width={100} height={100}/>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {TestimonialsArr.map((testimony)=>(
                <div className="flex flex-col justify-center items-center p-4 pt-8 border shadow rounded-xl">
                <Image src={testimony.imgRef} height={80} width={80} className="rounded-full"/>
